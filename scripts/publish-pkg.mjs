...
// the registry. The release workflow publishes the versions currently in the manifests; usually only
// the bumped package is new. Without this guard, `pnpm publish` errors on the first already-published
// package and the whole tagged release dies before reaching the new one.
//
